      ...
      <section className="pt-20 pb-10 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-3 text-white">Contact <span className="text-green-300">Us</span></h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {contactInfo.map((info, idx) => (
              <motion.a
                ...
                className="bg-[#1a3a1a] rounded-xl p-5 text-center border border-green-500/20 hover:border-green-500/40 hover:bg-[#1a3a1a]/80 transition-all duration-300 group"
              >
                <div className="text-3xl text-green-400 mb-3 flex justify-center group-hover:scale-110 transition">
                  {info.icon}
                </div>
                <h3 className="text-white font-semibold text-sm mb-1">{info.title}</h3>
                <p className="text-green-300 text-xs font-medium">{info.details}</p>
                <p className="text-gray-500 text-[10px] mt-1">{info.sub}</p>
              </motion.a>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="bg-[#1a3a1a] rounded-xl p-6 border border-green-500/30"
            >
              <div className="mb-5">
                <h2 className="text-xl font-bold text-white mb-1">Send us a Message</h2>
                <p className="text-gray-400 text-xs">Fill out the form and we'll get back to you within 24 hours</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      required
                      rows="4"
                      className="w-full pl-9 pr-3 py-2 bg-[#0d2b0d] border border-green-500/30 rounded-lg focus:outline-none focus:border-green-400 text-white text-sm resize-none"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-green-600 py-2 rounded-lg font-medium text-sm hover:bg-green-500 transition text-white flex items-center justify-center gap-2"
                >
                  {loading ? (
                    "Sending..."
                  ) : (
            ...
            >
              {/* Office Location */}
              <div className="bg-[#1a3a1a] rounded-xl p-6 border border-green-500/30">
                <h3 className="text-white font-semibold text-base mb-3">Our Office</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <FaMapMarkerAlt className="text-green-400 text-base mt-0.5" />
                    <div>
                      <p className="text-white text-sm font-medium">MaviSolution Headquarters</p>
                      <p className="text-gray-400 text-xs">123 Tech Valley, Suite 100</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-300 text-sm">hello@mavisolution.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#1a3a1a] rounded-xl p-6 border border-green-500/30">
                ...
                <p className="text-gray-400 text-xs mb-4">Follow us on social media for updates and insights</p>
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-[#0d2b0d] flex items-center justify-center text-green-400 hover:bg-green-600 hover:text-white transition-all duration-300">
                    <FaLinkedin size={18} />
                  </a>
                  <a href="#" className="w-10 h-10 rounded-full bg-[#0d2b0d] flex items-center justify-center text-green-400 hover:bg-green-600 hover:text-white transition-all duration-300">
                    <FaTwitter size={18} />
              ...
              <div className="bg-gradient-to-r from-green-700 to-green-800 rounded-xl p-5 text-center">
                <FaHeadset className="text-3xl text-white mx-auto mb-2" />
                <h4 className="text-white font-semibold text-sm mb-1">24/7 Emergency Support</h4>
                <p className="text-green-100 text-xs mb-2">For urgent issues, our SRE team is always available</p>
                <a href="tel:+15551234567" className="inline-block bg-white/20 px-4 py-1.5 rounded-full text-white text-xs font-medium hover:bg-white/30 transition">
                  Call Emergency Line
                </a>
              </div>
            </motion.div>
      ...
      <section className="py-10 px-4 bg-[#0a2a0a]/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Find answers to common questions about our services</p>
          </div>
          <div className="grid md:grid-cols-2 gap-5">
            {faqs.map((faq, idx) => (
              <motion.div
                ...
                transition={{ delay: idx * 0.1 }}
                className="bg-[#1a3a1a] rounded-xl p-5 border border-green-500/20 hover:border-green-500/40 transition"
              >
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="bg-[#1a3a1a] rounded-xl p-6 text-center border border-green-500/30"
          >
            <FaRocket className="text-3xl text-green-400 mx-auto mb-3" />
            <h2 className="text-xl font-bold mb-2 text-white">Ready to Transform Your Business?</h2>
            <p className="text-gray-400 text-sm mb-4">Let's discuss how MaviSolution can help you achieve 99.99% uptime</p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="mailto:hello@mavisolution.com" className="inline-block bg-green-600 px-5 py-2 rounded-full font-medium text-sm hover:bg-green-500 transition text-white">
                Email Us Directly
              </a>
              <a href="/services" className="inline-block border border-green-500/60 px-5 py-2 rounded-full font-medium text-sm hover:bg-green-500/20 transition text-white">
                View Our Services
              </a>
            </div>
          </motion.div>
