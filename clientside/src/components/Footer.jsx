  ...
  return (
    <footer className="relative bg-[#1a3a1a] border-t border-green-500/30 mt-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex space-x-3 pt-4">
              <a href="#" className="text-gray-500 hover:text-green-400 transition p-1">
                <FaTwitter size={14} />
              </a>
              <a href="#" className="text-gray-500 hover:text-green-400 transition p-1">
                <FaLinkedin size={14} />
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link to={link.path} className="text-gray-400 hover:text-green-300 transition text-[11px] sm:text-xs">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <h3 className="text-white font-semibold text-sm sm:text-base mb-3 sm:mb-4">Our Services</h3>
            <ul className="space-y-1.5">
              {services.map((service) => (
                <li key={service} className="text-gray-400 text-[11px] sm:text-xs">
                  {service}
                </li>
              ))}
            </ul>
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2 text-gray-400 text-[11px] sm:text-xs">
                <FaMapMarkerAlt className="text-green-400 mt-0.5 flex-shrink-0" /> 
                <span>123 Tech Valley, San Francisco, CA</span>
              </div>
              <div className="flex items-center gap-2 text-gray-400 text-[11px] sm:text-xs">
                ...
                <span className="break-all">hello@mavisolution.com</span>
              </div>
              <div className="flex items-center gap-2 text-gray-400 text-[11px] sm:text-xs">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="border-t border-green-500/20 mt-6 sm:mt-8 pt-5 sm:pt-6 text-center">
